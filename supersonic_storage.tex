...
{\color{red} napisaæ jak siê to ma do zapisu i dlaczego smutne}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=1\textwidth]{images/read_queries_hdd.pdf}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=1\textwidth]{images/read_queries_ssd.pdf}
