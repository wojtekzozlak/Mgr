...
8\ GB)}
  \item{\textbf{Dyski}:
    \begin{itemize}
      \item{\textbf{SSD} - Samsung 840 Pro 256\ GB (przechowuj±cy równie¿ system
operacyjny)}
      \item{\textbf{HDD} - {\color{red} TODO}}
    \end{itemize}
  }
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{images/write_throughput.pdf}
  \caption{Przepustowo¶æ operacji zapisu w zale¿no¶ci od rozmiaru rodziny i
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{images/write_breakdown.pdf}
  \caption{Rozk³ad czasu zapisu na obliczenie i oczekiwanie na urz±dzenie.}
\end{figure}
...
danych na koñcu testu (za pomoc± funkcji \texttt{sync()}). Dodatkowo, liczony
by³ czas zu¿ywany na operacje wej¶cia / wyj¶cia - zarówno w warstwie fizycznej
magazynu jak i potrzebny na finaln± synchronizacjê danych. \\

Rysunek \ref{figure:write_throughput_ssd} przedstawia przepustowo¶æ operacji
zapisu dla dysku SSD.

{\color{red} TODO: Zrobiæ test dla HDD i napisaæ interpretacjê. Poprawiæ
czytelno¶æ wykresów.}
